...
from nlp_tools.allennlp_training_callbacks.callbacks import WanDBTrainingCallback, WanDBLogger
from nlp_tools.allennlp_training_callbacks.callbacks import TestAndWrite
from transformers import AdamW

from src.datasets.cache_callback import DatasetCacheCallback
from src.datasets.dataset_utils import build_outpath_subdirs, get_mapper, get_data, get_cached_dataset_file_name, \
...
from src.modelling.neural_wsd_models import WSDOutputWriter, WSDF1
...
def main(args):
    ...
    wandb.init(config=config, project="xl-wsd", tags=[socket.gethostname(), wsd_model_name, ",".join(langs)],
